...
const Login = props => {
    ...
    const disableSubmit = () => {
        ...
        if(displayError === CONSTANTS.ERRORS.EMAILID_LOGIN_ERROR || displayError === CONSTANTS.ERRORS.PASSWORD_LOGIN_ERROR)
        {
            // console.log("pattern error")
            return true
        }
        else if (displayError === CONSTANTS.ERRORS.LOGIN_ERROR)
        {
